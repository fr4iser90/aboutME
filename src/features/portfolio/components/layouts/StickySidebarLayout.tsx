 ...
 * Sidebar on left (sticky), content on right (scrollable)
 * 
 * Created: 2025-11-16
 */
...
/**
 * Sticky Sidebar Layout
 * Renders sticky sidebar on left, scrollable content on right
 */
export default function StickySidebarLayout({ 
  ...
  return (
    <div className="project-modal-layout project-modal-layout--sticky-sidebar">
        <aside className="project-sidebar project-sidebar--sticky">
