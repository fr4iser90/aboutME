...
describe('JSONValidator', () => {
  ...
  describe('nested object validation', () => {
    it('should validate nested techStack object', () => {
      ...
      const result = jsonValidator.validate(projectWithTechStack, projectSchema);
      expect(result.isValid).toBe(true);
    });

    it('should reject invalid nested object', () => {
      const projectWithInvalidTechStack = {
        id: 1,
        name: 'Test Project',
        description: 'Test description',
        techStack: {
      ...
      const result = jsonValidator.validate(projectWithInvalidTechStack, projectSchema);
      expect(result.isValid).toBe(false);
    });
  });
  ...
  describe('array validation', () => {
    it('should validate array of strings', () => {
      ...
      const result = jsonValidator.validate(projectWithArrays, projectSchema);
      expect(result.isValid).toBe(true);
    });

    it('should reject array with wrong type', () => {
      const projectWithInvalidArray = {
        id: 1,
        name: 'Test Project',
        description: 'Test description',
        topics: [1, 2, 3] // Should be strings
      };

      const result = jsonValidator.validate(projectWithInvalidArray, projectSchema);
      expect(result.isValid).toBe(false);
    });
  });
  ...
  describe('type validation', () => {
    it('should validate string type', () => {
      ...
      const result = jsonValidator.validate(project, projectSchema);
      expect(result.isValid).toBe(true);
    });
