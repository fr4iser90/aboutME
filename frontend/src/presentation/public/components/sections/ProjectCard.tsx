...
export const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  return (
    <div className="project-card-root" style={{ background: 'var(--theme-semantic-card)', color: 'var(--theme-semantic-card-foreground)', boxShadow: 'var(--theme-shadow-default)', borderRadius: 'var(--theme-border-radius-lg)' }}>
      {project.imageUrl && (
        <img
      ...
      <h3 className="project-card-title" style={{ color: 'var(--theme-primary)' }}>{project.title}</h3>
      <p className="project-card-desc" style={{ color: 'var(--theme-semantic-muted-foreground)' }}>{project.description || 'No description available'}</p>
      <div className="project-card-badges-row">
        ...
        {project.topics?.map((topic) => (
          <span
            key={topic}
            className="project-card-badge-muted"
      ...
      <div className="project-card-meta-row">
        {typeof project.starsCount === 'number' && (
          <div className="project-card-meta-item">
            <svg className="project-card-meta-icon" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="project-card-links-row">
        {project.githubUrl && (
          <a
      ...
      {project.updatedAt && (
        <div className="project-card-updated" style={{ color: 'var(--theme-semantic-muted-foreground)' }}>
